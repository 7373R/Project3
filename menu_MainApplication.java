...
//        playButton.setIcon(new MyImageIcon(MyConstants.FILE_PLAY).resize(buttonSize));
//        playButton.setPressedIcon(new MyImageIcon(MyConstants.FILE_PLAYHOVER).resize(buttonSize));
